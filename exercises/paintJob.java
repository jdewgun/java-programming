...
public class paintJob {
    ...
    public static void main(String[] args) {
        // Tests
        System.out.println("Bucket Count: " + getBucketCount(3.4, 1.5));
        System.out.println("Bucket Count: " + getBucketCount(6.26, 2.2));
        System.out.println("Bucket Count: " + getBucketCount(3.26, 0.75));
        ...
        System.out.println("Bucket Count: " + getBucketCount(-3.4, 2.1, 1.5));
        System.out.println("Bucket Count: " + getBucketCount(3.4, 2.1, 1.5));
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBucket) {
        if ((width <= 0) || (height <= 0) || (areaPerBucket <= 0) || (extraBucket < 0)) {
            ...
            int need = (int) Math.ceil((width * height) / areaPerBucket - ((double) extraBucket));
            return need;
        }
    }
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket) {
        if ((width <= 0) || (height <= 0) || (areaPerBucket <= 0)) {
            ...
            int need = (int) Math.ceil((width * height) / areaPerBucket);
            return need;
        }
    }
    ...
    public static int getBucketCount(double area, double areaPerBucket) {
        ...
        int need = (int) Math.ceil(area / areaPerBucket);
        return need;
    }
}
