...
public class Exercise2 {
     ...
     *
     * NOTE: The solution will not be accepted if there are extra spaces. NOTE: The
     * printMegaBytesAndKiloBytes method needs to be defined as public static like
     * we have been doing so far in the course.NOTE: Do not add a main method to
     * solution code.
     */
    ...
    public static void printMegaBytesAndKiloBytes(int kiloBytes) {
        if (kiloBytes >= 0) {
            int megaBytesVal = kiloBytes / 1024;
            int remainingKilobytes = kiloBytes % 1024;
            System.out.println(kiloBytes + " KB = " + megaBytesVal + " MB and " + remainingKilobytes + " KB");
        } else {
