...
public class Exercise1 {
    /*
     * EXERCISE 1: 1. Write a method called toMilesPerHour that has 1 parameter of
     * type double with the name kilometersPerHour. This method needs to return the
     * rounded value of the calculation of type long.
     *
     ...
     * below.
     *
     * Examples of input/output: toMilesPerHour(1.5); → should return value 1
     * toMilesPerHour(10.25); → should return value 6 toMilesPerHour(-5.6); → should
     * return value -1 toMilesPerHour(25.42); → should return value 16
     ...
     * text (into the console - System.out): 1.5 km/h = 1 mi/h
     * printConversion(10.25); → should print the following text (into the console -
     * System.out): 10.25 km/h = 6 mi/h printConversion(-5.6); → should print the
     * following text (into the console - System.out): Invalid Value
     * printConversion(25.42); → should print the following text (into the console -
     * System.out): 25.42 km/h = 16 mi/h printConversion(75.114); → should print the
     * following text (into the console - System.out): 75.114 km/h = 47 mi/h
     *
     *
    ...
    public static long toMilesPerHour(double kilometersPerHour) {
        long convertedMiles = -1;

        if (kilometersPerHour >= 0) {
            convertedMiles = Math.round((kilometersPerHour / 1.609));
        }
