...
public class Contact {
    ...
    public Contact(String nameVal, String phoneNumberVal) {
        this.name = nameVal;
    ...
    public static Contact createContact(String nameVal, String phoneNumberVal) {
        return new Contact(nameVal, phoneNumberVal);
    }
